...
export default function LogIn() {
  ...
  return (
    <div className="inset-auto flex flex-col w-screen min-w-[400px] h-screen max-w-screen-2xl md:flex-row">
      <div className="fixed z-20 py-1 rounded-md max-md:shadow-md bg-white/80 top-2 left-2 before:static ">
      </div>
      <div className="bg-fixed bg-white bg-center aspect-[773/499] bg-no-repeat bg-contain max-xs:scale-x-125 sm:self-stretch md:bg-top-4 max-md:h-fit max-md:bg-top min-h-72 md:bg-cover md:bg-origin-border md:overflow-x-clip md:w-1/2 md:order-2 max-md:w-screen -z-50 bg-jesus-hero md:bg-clip-border"></div>
