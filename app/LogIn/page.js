...
export default function LogIn() {
  ...
  return (
    <div className="relative w-screen h-screen mx-auto max-w-screen-2xl md:flex">
      ...
      <div className="z-50 flex flex-col w-full gap-1 md:gap-3 max-md:justify-between md:h-full md:pt-7 md:items-center md:justify-between md:w-1/2">
        <Image
